  ...
  return (
    <section className="py-16 lg:py-20">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-6">
        <div className="text-xs tracking-[0.18em] text-indigo-300 font-semibold">{t("process.label")}</div>
        <h2 className="mt-2 text-[28px] md:text-[36px] font-bold tracking-[-0.02em] text-white">{t("process.title")}</h2>
