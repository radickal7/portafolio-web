    ...
    <section id="projects" className="py-16 lg:py-20">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-6">
        ...
        <div className="mt-8 grid lg:grid-cols-3 gap-4">
          {projects.map((p, i) => (
            <motion.div key={p.slug} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }} className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-5 flex flex-col">
              ...
              <p className="mt-2 text-sm text-slate-400 leading-relaxed">{p.summary}</p>
